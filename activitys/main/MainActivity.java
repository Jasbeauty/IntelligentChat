package com.wenjiasun.Chat.activitys.main;
...
import com.wenjiasun.Chat.R;
import com.wenjiasun.Chat.activitys.BaseActivity;
import com.wenjiasun.Chat.adapter.ChatAdapter;
import com.wenjiasun.Chat.app.AppConfig;
import com.wenjiasun.Chat.broadcastreceiver.MyReceiver;
import com.wenjiasun.Chat.entity.ChatMsgEntity;
import com.wenjiasun.Chat.utils.JsonParser;
...
//        tv_sound_insert.performClick();
    ...
    private void initData(){
        ...
        intentFilter.addAction("com.wenjiasun.Chat.broadcastreceiver.MyReceiver");
        ...
        ChatMsgEntity chatMsgEntity=new ChatMsgEntity(you_name,"{\"code\":100000,\"text\":\"我是CiCi，很高兴认识你，一起聊聊吧～\"}", ChatMsgEntity.Type.you,new Date());
        ...
        try {
            ...
            queue.add(new StringRequest(url,new Response.Listener<String>() {
                ...
                public void onErrorResponse(VolleyError volleyError) {
                    replyMsgHandler("{\"code\":100000,\"text\":\"您的问题太深奥了，CiCi难以回答1\"}");
                }
            }));
        } catch (UnsupportedEncodingException e) {
            replyMsgHandler("{\"code\":100000,\"text\":\"您的问题太深奥了，CiCi难以回答2\"}");
        }
